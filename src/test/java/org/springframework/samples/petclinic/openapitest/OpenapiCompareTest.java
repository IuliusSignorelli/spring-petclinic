...
public class OpenapiCompareTest {
	...
	public void getDiffSpec() throws FileNotFoundException {
      ...
      /*  WebTestClient webClient = WebTestClient.bindToServer().baseUrl("http://localhost:" + port).build();
		...
		try {
			FileWriter fw = new FileWriter(new File(System.getProperty("user.dir") + "/target/generated-openapi/testDiff.txt"));
		...
		try {
			FileWriter fw = new FileWriter(new File(System.getProperty("user.dir") + "/target/generated-openapi/testNewApi.html"));
